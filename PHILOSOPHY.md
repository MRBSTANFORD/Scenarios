# The CORKBRICK Philosophy: Play, Build, Sustain

Welcome to the heart of **CORKBRICK Play**! 

If you've found your way here, you probably share our vision: that technology shouldn't isolate us, but rather bring us together to solve real-world problems. This document outlines the core values driving CORKBRICK and our digital sandbox, CORKBRICK Play.

## Who We Are
CORKBRICK is a sustainable, modular system that allows anyone to build furniture, walls, and structures without tools or glue—using only natural cork. Learn more about our real-world products at [corkbrick.com](https://corkbrick.com).

## CORKBRICK Play: The Digital Laboratory
CORKBRICK Play is our interactive 3D builder and physics engine. But it is more than just a digital toy. It is a **laboratory for the real world**. 
...
- **Tools for Collaboration and Creation**?
- **Bridging the Digital and Physical Worlds**?

We want you involved! CORKBRICK Play is a continuous work in progress, driven by a community that believes in making the world a better place, one block at a time. Dive into our codebase, propose new features, enhance the simulation, or help us build out new challenge systems.

Together, we can build a more sustainable future—no tools required.
